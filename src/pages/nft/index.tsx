...
export default function NFT() {
  ...
  return (
    <>
      ...
      <div className="font-digital over relative z-20 flex h-full min-h-[100vh] w-full flex-col items-center justify-between overflow-x-hidden bg-black text-white lg:justify-start">
      ...
      <div className="font-digital z-50 flex min-h-[100vh] w-[360px] flex-col gap-5 pl-[40px] pt-[50px] text-white lg:absolute lg:bottom-[60px] lg:left-[50px] lg:min-h-0 lg:bg-opacity-60 lg:p-0">
