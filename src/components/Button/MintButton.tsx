...
export default function MintButton({ title, arrow }: Props) {
  ...
  return (
    <div className="flex w-full items-center justify-center">
      ...
      />
      <button
        className="bg-buttonW shadow-buttonW hover:bg-buttonG hover:text-buttonGr hover:shadow-buttonG hover:border-buttonGr h-[45px] w-[17%] border-[0.5px] border-white transition-all"
