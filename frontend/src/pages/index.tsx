...
export default function NFT() {
  const [totalSupply, setTotalSupply] = useState(7007);
  ...
  return (
    <>
      ...
      <div className="over relative z-20 flex h-full min-h-[100vh] w-full flex-col items-center justify-between overflow-x-hidden bg-black font-digital text-white lg:justify-start">
        ...
        <div className="z-20 mb-[35%] flex w-full flex-col items-center gap-4 text-center lg:mb-0 lg:mt-[19.5%]">
          ...
          <BaseBtn
            ...
            onClick={() => {
              openLink(
                "https://magiceden.io/collections/ethereum/0x42537d4e19d7888d8d5a867a51911bde569d9e9d",
              );
            }}
          />
      ...
      <div className="z-50 flex min-h-[100vh] w-[360px] flex-col gap-5 pl-[9%] pt-[50px] font-digital text-white lg:absolute lg:bottom-[60px] lg:left-[50px] lg:min-h-0 lg:bg-opacity-60 lg:p-0">
